...
c, G, D ⊢ 
  ...
  Definition cut_admissibility_t n m c G G' D1 D2 D1' D2' A A' A'':=
    D1 ≡[P] D1' ++ A ->
    D2 ≡[P] D2' ++ A' ->
    G ≡[P] G' ++ A'' ->
    n ⊣ c, G', D1 ⊢pf ->
  ...
  Definition cut_admissibility1 n m c u G D1 D2 D1' D2' := cut_admissibility_t n m c G G D1 D2 D1' D2' [u] [dual u] [].
  Print cut_admissibility1.
